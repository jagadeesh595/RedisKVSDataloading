 ...
 */
@Entity
@Table(name = "BOQALP_BonusQualification")
public class BoqalpBonusQualification {
    private Long id;
    private Long bqctlDistCtrl;
    private Integer bqlayrLastActiveYear;
    private Integer bqlamoLastActiveMonth;
    private Integer bqcnsaConsecutiveActive;
    private Integer bqlqyrLastQualYear;
    private Integer bqlqmoLastQualMonth;
    private Integer bqcnsqConsecutiveQual;
    private String bq4Ccw4CcWaiver;
    private String bqldbwLdrshipBonWaiver;
    private String bqpaypLdrshipBonElig;
