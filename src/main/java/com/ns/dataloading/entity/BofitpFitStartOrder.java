 ...
 */
@Entity
@Table(name = "BOFITP_FitStartOrder")
public class BofitpFitStartOrder {
    private Long id;
    private String bfcoidCompId;
    private Long bfctlDistCtrl;
    private Long bfordOrderNum;
    private Integer bfpyrYear;
    private Integer bfpmoMonth;
    private String bfodatOrderDate;
    private BigDecimal bfordccOderCasCre;
    private BigDecimal bfndpccNdpcc;
    private BigDecimal bfwhlccWhlcc;
    private String bfpdatCreatedDate;
    private String bfcusrLstChangeUser;
    private Long bfordsOrderSrcCode;
    private Long bfshpsShippingSrcCode;
    private Long bfotypOrderTypeCode;
    private String bfedteEntryTimeStamp;
    private String bfcdteChangeTimeStamp;
    private String bflitpLiteraturePakYOrN;
    private String bflngSyjLang;
