...
@RedisHash("ORDTLP_OrderDetailFile")
public class OrdtlpOrderDetailFile implements Serializable {
    private Long id;
    private @Indexed Integer orpyrProcessYear;
    private @Indexed Integer orpmoProcessMonth;
    private @Indexed Long orordOrderNumber;
    private @Indexed Long orenvEnvelopeNumber;
    private @Indexed Long orparaPurchaceArea;
    private @Indexed Long orctlDistributorControl;
    private @Indexed Long orqtyQuantityOfProduct;
    private @Indexed Long orqshpShippedQuantity;
    private @Indexed Long orqboBackOrderQuantity;
    private @Indexed String orprdProductNumber;
    private @Indexed String orrevRevisionNumber;
    private @Indexed String orptypProductType;
    private @Indexed String orunitUnitOfProduct;
    private @Indexed BigDecimal orcscrCaseCredits;
    private @Indexed BigDecimal orsrpSrpOfProduct;
    private @Indexed BigDecimal orwhsWholeSaleCostOfProduct;
    private @Indexed BigDecimal orndpNdpAmount;
    private @Indexed BigDecimal orslpSalesPriceOfItem;
    private @Indexed BigDecimal ortaxTaxOfOrder;
    private @Indexed Integer orseqSequenceNumber;
    private @Indexed String ordateDateOfOrder;
    private @Indexed String oruserLastChangeUser;
    private @Indexed String ortxblTaxableItemYorN;
    private @Indexed BigDecimal orwghtWeight;
    private @Indexed String oredteEntryTimeStamp;
    private @Indexed String orcdteChangeTimeStamp;
