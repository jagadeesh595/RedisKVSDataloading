 ...
 */
@Entity
@Table(name = "DSMSTP_Distributor")
public class DsmstpDistributor {
    private Long id;
    private Long dsctlControl;
    private Long dsdidId;
    private String dsfnamFirstName;
    private String dslnamLastName;
    private Long dsspnSponsorControl;
    private String dscntyCountry;
    private Long dsctycCntrCode;
    private String dsstasStatus;
    private String dswaiv4CcWaiver;
    private Integer dslevlLevel;
    private Integer dsmgrlMgrLevel;
    private Integer dsgmlvGemMgrLevel;
    private String dsqudsForiegnQual;
    private String dsdqmgRecognizedManager;
    ...
    private String dstrfmTransferredMgr;
    private String dsinhmInheritMgr;
    ...
    private String dsfrdcForiegnDom;
    private String dsqumgForiegnQualMgr;
    private String dsfedCorpFedTaxNum;
    private Integer dsssrcSponsoringSrc;
