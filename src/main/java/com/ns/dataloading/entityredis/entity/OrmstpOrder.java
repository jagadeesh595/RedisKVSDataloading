...
@RedisHash("ORMSTP_Order")
//@Table(name = "ORMSTP_Order")
public class OrmstpOrder implements Serializable {
    @Id
     private  @Indexed Long id;
     private  @Indexed Long omordNumber;
     private  @Indexed Long omctlDistCtrl;
     private  @Indexed Integer ompyrYear;
     private  @Indexed Integer ompmoMonth;
     private  @Indexed String omodatDate;
     private  @Indexed Long omdidDistId;
     private  @Indexed BigDecimal ompsrpProdSrp;
     private  @Indexed BigDecimal ompndpProdNdp;
     private  @Indexed BigDecimal ompwhsProdWhs;
     private  @Indexed BigDecimal omtsrpTotSrp;
     private  @Indexed String omptypPriceType;
     private  @Indexed BigDecimal omccrdCredits;
     private  @Indexed BigDecimal ompcasPhyCases;
     private  @Indexed BigDecimal omtwhsTotWhs;
     private  @Indexed BigDecimal omtndpTotNdp;
     private  @Indexed String omcoidCompanyCode;
     private  @Indexed Long omctycCntryCode;
     private  @Indexed String omcurcCurrCode;
     private  @Indexed BigDecimal omdiscPersonalDiscAmt;
     private  @Indexed BigDecimal omptaxProdTax;
     private  @Indexed BigDecimal omlsrpLitSrp;
     private  @Indexed BigDecimal omlwhsLitrWhsCost;
     private  @Indexed BigDecimal omlndpLitrNdp;
     private  @Indexed BigDecimal omltaxLitrTax;
     private  @Indexed BigDecimal omtslpTotSalesPrice;
     private  @Indexed BigDecimal omttaxTotTax;
     private  @Indexed BigDecimal omifeeImportFee;
     private  @Indexed BigDecimal omhchgShipHandChg;
     private  @Indexed BigDecimal omwghtTotWeight;
     private   BigDecimal omshipShippingCharge;
     private   BigDecimal omhandHandlingCharge;
     private  @Indexed Long omareaDistArea;
     private  @Indexed Long omparaPurchaseArea;
     private  @Indexed Long omenvEnvNum;
     private  @Indexed String omdateLastChangeDate;
     private  @Indexed String omuserLastChangeUser;
     private   BigDecimal omtxblNetTaxAmt;
     private BigDecimal omntxbNetNonTaxAmt;
     private  @Indexed String omgmbnPayGmasmbon;
     private  @Indexed Long omdmDistMgrId;
     private  @Indexed String omntxfNonTaxFlag;
     private  @Indexed Long omordsOrderSrcCode;
     private  @Indexed Long omshpsShippingSrcCode;
     private  @Indexed Long omotypOrderTypeCode;
     private  @Indexed String omjdefJdeFlag;
     private  @Indexed String omndpfNdpFlag;
     private  @Indexed String omwebWebNum;
     private  @Indexed BigDecimal omexrtCurrExchRate;
     private  @Indexed String omedteEntryTimeStamp;
     private  @Indexed String omcdteChangeTimeStamp;
     private  @Indexed BigDecimal omdbalDiscBalConsumed;
     private  @Indexed BigDecimal omdpctPerDiscPerc;
     private  @Indexed Long omdtrnPerDiscTran;
     private  @Indexed String omgflgGenericFlag;
