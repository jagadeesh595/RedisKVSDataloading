...
@Entity
@Table(name = "BOHSTP_BonusHistory")
public class BohstpBonusHistory {
    private Long id;
    private Long bhctlDistCtrl;
    private Integer bhpyrYear;
    private Integer bhpmoMonth;
    private BigDecimal bhtamtTotBonAmt;
    private BigDecimal bhtamt1PerDiscAmt;
    private BigDecimal bhtamt2RetPerBonAmt;
    private BigDecimal bhtamt3GrpBonAmt;
    private BigDecimal bhpcasPerCasCre;
    private BigDecimal bhdcasDistCasCre;
    private BigDecimal bhtacsTotActCasCre;
    private String bhactfActiveFlag;
    private BigDecimal bhncasNonMgrCasCre;
    private BigDecimal bhtccrTotCasCre;
    private BigDecimal bhphycPhyCasCre;
    private String bhcoidCompCode;
    private String bhwaivVolWaiv;
    private String bhldbwLbWaiv;
    private String bhqumgLbQual;
    private String bhpaypLbElig;
    private BigDecimal bhpuccPushupCasCre;
    private Integer bhlbmgLbMgrs;
    private Integer bhblevBegLev;
    private Integer bhelevEndLev;
    private String bhdqmgRecMgr;
    private Integer bhmgrlMgrLev;
    private Integer bhgmlvGemLev;
    private BigDecimal bhaytdTotBonAmtYtd;
    private BigDecimal bhpytdPerCasCreYtd;
    private BigDecimal bhdytdDistCasCreYtd;
    private BigDecimal bhtaydTotActCasCreYtd;
    private BigDecimal bhnytdNonMgrCasCreYtd;
    private BigDecimal bhtytdTotCasCreYtd;
    private BigDecimal bhhytdPhyCasCreYtd;
    private Long bhchkCheckNum;
    private BigDecimal bhadjnAdjNon1099;
    private BigDecimal bhadjAdj1099;
    private Long bhareaDistArea;
    private Integer bh1GamFrtsGenActMgrs25Cc;
    private BigDecimal bhnwccNewNonMgrCc;
    private BigDecimal bhnwpsNewNmccPs;
    private BigDecimal bhwytdNewNmccForPsYtd;
