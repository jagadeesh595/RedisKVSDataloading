...
@Entity
@Table(name = "CBWCCP_WorldWideCC")
public class CbwccpWorldWideCc {
    private Long id;
    private Long bwctycCountryCode;
    private Long bwdidDistributorId;
    private Integer bwpyrProcessingYear;
    private Integer bwpmoProcessingMonth;
    private String bwcntyIsoCountryCode;
    private String bwnwmgNewRecMgrFlag;
    private Integer bwbrkyrBreakYear;
    private Integer bwbrkmoBreakMonth;
    private BigDecimal bwtlccYtdTotalCc;
    private BigDecimal bwpnccYtdPerOrNmCc;
    private BigDecimal bwnwpsYtdNewNmCCorCb;
