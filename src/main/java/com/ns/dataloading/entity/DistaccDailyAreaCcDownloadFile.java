...
@Entity
@Table(name = "DISTACC_DailyAreaCCDownloadFile")
public class DistaccDailyAreaCcDownloadFile {
    private Long id;
    private String aregnRegion;
    private Long aareaArea;
    private String aadescAreaDescriotion;
    private Integer acpmthCurrMth;
    private Integer acpyrCurrYr;
    private BigDecimal acpphyCurrMthParaPhyc;
    private BigDecimal acdphyCurrMthDaraPhyc;
    private BigDecimal acpcscCurrMthParaCasc;
    private BigDecimal acdcscCurrMthDaraCasc;
    private Integer appmthPriMth;
    private Integer appyrPriYr;
    private BigDecimal appphyPriMthParaPhyc;
    private BigDecimal apdphyPriMthDaraPhyc;
    private BigDecimal appcscPriMthParaCasc;
    private BigDecimal apdcscPriMthDaraCasc;
    private String ausridUserId;
    private String apswrdPassword;
