...
@Entity
@Table(name = "FLCMPP_CompanyConfig")
public class FlcmppCompanyConfig {
    private Long id;
    private String flcoidCompanyCode;
    private String flcmpnCompanyName;
    private String flcmshShortCmpnyName;
    private String flstatStateCode;
    private String flcntyCountryCode;
    private String flcurrCurrencySymbol;
    private String flcrvbCurrencyVerbage;
    private Integer fldecpDecimalPosition;
    private BigDecimal flcrncCurrencyCasCre;
    private String fllbedLbBonEffDate;
    private String flgfedGrandFatherEffDate;
    private BigDecimal fldwthDomWhPct;
    private BigDecimal flfwthForiegnWhPct;
    private String flcmcnCmpnyNameCenter;
    private String fladd1AddrLine1;
    private String fladd2AddrLine3;
    private String fladd3AddrLine4;
    private String fladd4AddrLine5;
    private String flcityCity;
    private String flzipcZipCode;
    private Long flphonPhoneNum;
    private String flfnamCfoFrstName;
    private String fllnamCfoLastName;
    private String flalbtAllowBottleProc;
    private String flcorcCCorCurrency;
    private String flmnamMerchName;
    private String flmacMerchAcct;
    private Long flmdcManagingDirCtrl;
    private String fldfmtDateDispFrmt;
    private Integer flfm01EarningsOne;
    private Integer flfm02ProfitSharing;
    private Integer flfm03MonthEndReports;
    private Integer flfm04EarnedRallyTrips;
    private Integer flfm05FutureOne;
    private Integer flfm06FutureTwo;
