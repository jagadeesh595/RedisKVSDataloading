 ...
 */
@Entity
@Table(name = "DSPWVP_Waiver")
public class DspwvpWaiver {
    private Long id;
    private Long pwctlDistCtrl;
    private String pwonemOneMonthWaiver;
    private String pwcdatLastChangeDate;
    private String pwcusrLastChangeUser;
    private Long pwctycCountryCode;
    private Long pwdidDistId;
    private String pwlbwfLdrshipWaiverFlag;
    private String pwcntyAlphaCountryCode;
